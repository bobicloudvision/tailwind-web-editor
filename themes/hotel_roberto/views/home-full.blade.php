    ...
    <div webesembly:page="home">
        ...
        <section class="welcome-area" webesembly:section="welcome-area">
            <div class="welcome-slides owl-carousel">
                ...
                <!-- Single Welcome Slide -->
                <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{asset('themes/hotel_roberto')}}/img/bg-img/17.jpg);" data-img-url="{{asset('themes/hotel_roberto')}}/img/bg-img/17.jpg">
                    <!-- Welcome Content -->
                    <div class="welcome-content h-100">
                        <div class="container h-100">
                            <div class="row h-100 align-items-center">
                ...
                <!-- Single Welcome Slide -->
                <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{asset('themes/hotel_roberto')}}/img/bg-img/18.jpg);" data-img-url="{{asset('themes/hotel_roberto')}}/img/bg-img/18.jpg">
                    <!-- Welcome Content -->
                    <div class="welcome-content h-100">
                        <div class="container h-100">
                            <div class="row h-100 align-items-center">
        ...
        <section class="roberto-about-area section-padding-100-0" webesembly:section="about-us">
            ...
            <div class="container mt-100">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6">
                        <!-- Section Heading -->
                        <div class="section-heading wow fadeInUp" data-wow-delay="100ms" webesembly:editable="true">
                            <h6>About Us</h6>
                            <h2>Welcome to <br>Roberto Hotel Luxury</h2>
                        </div>
                        <div class="about-us-content mb-100" webesembly:editable="true">
                            ...
                            <div class="row no-gutters">
                                <div class="col-6">
                                    <div class="single-thumb">
                                        <img src="{{asset('themes/hotel_roberto')}}/img/bg-img/13.jpg" alt="">
                                    </div>
                                    <div class="single-thumb">
                                        <img src="{{asset('themes/hotel_roberto')}}/img/bg-img/14.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="single-thumb">
                                        <img src="{{asset('themes/hotel_roberto')}}/img/bg-img/15.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container mt-100">
                <div webesembly:flex-grid="true" webesembly:editable="true">

                    <div style="background:red;z-index:1;grid-area: 6 / 3 / 7/ 9;">
        ...
        <section class="roberto-service-area" webesembly:section="service-area">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="service-content d-flex align-items-center justify-content-between" webesembly:editable="true">
                            <!-- Single Service Area -->
                            ...
                            <div class="single-service--area mb-100 wow fadeInUp" data-wow-delay="300ms">
                                <img src="{{asset('themes/hotel_roberto')}}/img/core-img/icon-2.png" alt="">
                                <h5>Reiseservice</h5>
                            </div>

                            <!-- Single Service Area -->
                            <div class="single-service--area mb-100 wow fadeInUp" data-wow-delay="500ms">
                                <img src="{{asset('themes/hotel_roberto')}}/img/core-img/icon-3.png" alt="">
                                <h5>Spa Relaxtion</h5>
                            </div>

                            <!-- Single Service Area -->
                            <div class="single-service--area mb-100 wow fadeInUp" data-wow-delay="700ms">
                                <img src="{{asset('themes/hotel_roberto')}}/img/core-img/icon-4.png" alt="">
                                <h5>Restaurant</h5>
                            </div>
        ...
        <section class="roberto-rooms-area">
            <div class="rooms-slides owl-carousel">
                ...
                <div class="single-room-slide d-flex align-items-center">
                    <!-- Thumbnail -->
                    <div class="room-thumbnail h-100 bg-img" style="background-image: url({{asset('themes/hotel_roberto')}}/img/bg-img/16.jpg);"></div>
                ...
                <div class="single-room-slide d-flex align-items-center">
                    <!-- Thumbnail -->
                    <div class="room-thumbnail h-100 bg-img" style="background-image: url({{asset('themes/hotel_roberto')}}/img/bg-img/17.jpg);"></div>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-6">
                        <div class="testimonial-thumbnail owl-carousel mb-100">
                            <img src="{{asset('themes/hotel_roberto')}}/img/bg-img/10.jpg" alt="">
                            <img src="{{asset('themes/hotel_roberto')}}/img/bg-img/11.jpg" alt="">
                        </div>
                    </div>
        ...
        <section class="roberto-project-area">
            ...
            <div class="projects-slides owl-carousel">
                ...
                <div class="single-project-slide active bg-img" style="background-image: url({{asset('themes/hotel_roberto')}}/img/bg-img/5.jpg);">
                    <!-- Project Text -->
                ...
                <!-- Single Project Slide -->
                <div class="single-project-slide bg-img" style="background-image: url({{asset('themes/hotel_roberto')}}/img/bg-img/6.jpg);">
                    <!-- Project Text -->
                    <div class="project-content">
                        <div class="text">
                            <h6>Entertaiment</h6>
                ...
                <!-- Single Project Slide -->
                <div class="single-project-slide bg-img" style="background-image: url({{asset('themes/hotel_roberto')}}/img/bg-img/8.jpg);">
                    <!-- Project Text -->
                    <div class="project-content">
                        <div class="text">
                            <h6>Entertaiment</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="300ms">
                            <a href="#" class="post-thumbnail"><img src="{{asset('themes/hotel_roberto')}}/img/bg-img/2.jpg" alt=""></a>
                            <!-- Post Meta -->
                            <div class="post-meta">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                            <a href="#" class="post-thumbnail"><img src="{{asset('themes/hotel_roberto')}}/img/bg-img/3.jpg" alt=""></a>
                            <!-- Post Meta -->
                            <div class="post-meta">
                                <a href="#" class="post-date">Jan 02, 2019</a>
                                <a href="#" class="post-catagory">Event</a>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="700ms">
                            <a href="#" class="post-thumbnail"><img src="{{asset('themes/hotel_roberto')}}/img/bg-img/4.jpg" alt=""></a>
                            <!-- Post Meta -->
                            <div class="post-meta">
                                <a href="#" class="post-date">Jan 02, 2019</a>
                                <a href="#" class="post-catagory">Event</a>
                ...
                <div class="cta-content bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/1.jpg);">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-7">
                            <div class="cta-text mb-50" webesembly:editable="true">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="partner-logo-content d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="300ms">
                            <!-- Single Partner Logo -->
                            <a href="#" class="partner-logo"><img src="{{asset('themes/hotel_roberto')}}/img/core-img/p1.png" alt=""></a>
                            <!-- Single Partner Logo -->
                            <a href="#" class="partner-logo"><img src="{{asset('themes/hotel_roberto')}}/img/core-img/p2.png" alt=""></a>
                            <!-- Single Partner Logo -->
                            <a href="#" class="partner-logo"><img src="{{asset('themes/hotel_roberto')}}/img/core-img/p3.png" alt=""></a>
                            <!-- Single Partner Logo -->
                            <a href="#" class="partner-logo"><img src="{{asset('themes/hotel_roberto')}}/img/core-img/p4.png" alt=""></a>
                            <!-- Single Partner Logo -->
                            <a href="#" class="partner-logo"><img src="{{asset('themes/hotel_roberto')}}/img/core-img/p5.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
