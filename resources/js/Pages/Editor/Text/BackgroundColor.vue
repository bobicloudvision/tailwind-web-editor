<template>
    <div class="block bg-sm font-medium text-gray-700">
        Background Color
    </div>
...
export default {
    ...
    methods: {
        changeColor: function () {
            ...
            this.currentElement.classList.add('bg-' + this.selectedColor.name);
